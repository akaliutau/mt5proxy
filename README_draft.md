...
## 10. Uploading report to the cloud

```bash
sudo docker cp mt5proxy:/home/trader/ReportHistory-10169.xlsx ./ReportHistory-10169.xlsx
gcloud storage cp ./ReportHistory-10169.xlsx gs://charts-alphard3/ReportHistory-10169.xlsx
```
